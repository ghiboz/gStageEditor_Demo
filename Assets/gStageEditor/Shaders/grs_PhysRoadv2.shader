...
Shader "gRally/Phys Road v2"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float clampResult201 = clamp( ( lerpResult150 + ( tex2DNode178.r * ( 1.0 - ( temp_output_174_0 * temp_output_173_0 ) ) ) + ( ( 1.0 - ( temp_output_174_0 * temp_output_176_0 ) ) * tex2DNode178.g ) + ( ( 1.0 - ( temp_output_177_0 * temp_output_173_0 ) ) * tex2DNode178.b ) + ( ( 1.0 - ( temp_output_177_0 * temp_output_176_0 ) ) * tex2DNode178.a ) ) , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=14401
1967;63;1762;925;4423.745;1599.084;3.385003;True;True
Node;AmplifyShaderEditor.RangedFloatNode;165;-5468.566,617.5628;Float;False;Property;_PuddlesSize;Puddles Size;10;0;Create;True;0;1.66;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;168;-4626.375,560.5538;Float;True;2;2;0;FLOAT;0.0;False;1;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StepOpNode;173;-4168.303,823.3531;Float;True;2;0;FLOAT;0.5;False;1;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StepOpNode;174;-4181.077,549.6039;Float;True;2;0;FLOAT;0.5;False;1;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;177;-3947.477,662.7542;Float;False;1;0;FLOAT;0.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;202;-3353.478,353.0615;Float;False;1;0;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;204;-3308.282,847.001;Float;False;1;0;FLOAT;0.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;178;-3656.103,52.02406;Float;True;Property;_PuddlesTexture;Puddles Texture;9;0;Create;True;None;5dfd7f20145df274dbbb19fa2310cad8;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;205;-3310.972,1120.036;Float;False;1;0;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;203;-3332.491,603.5555;Float;False;1;0;FLOAT;0.0;False;1;FLOAT;0
...
WireConnection;187;1;178;4
WireConnection;189;0;204;0
WireConnection;189;1;178;3
WireConnection;190;0;178;1
WireConnection;190;1;202;0
WireConnection;188;0;203;0
WireConnection;188;1;178;2
...
ASEEND*/
//CHKSM=79418812BB966947EE42A301004D8250D5B82914